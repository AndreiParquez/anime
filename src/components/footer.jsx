...
const Footer = () => {
    ...
    return (
        <div className='px-0 xl:px-56 sm:px-2 lg:px-40 md:px-32'>
            <div
                className="relative bg-cover bg-center h-48 w-full"
                    ...
                    <div className="bg-zinc-950 p-4 relative rounded">
                        ...
                        <div className="flex">
                            <p className="text-zinc-500 text-center font-bold text-xs">
                                Developed by 
                                <span className='tracking-widest font-custom font-bold text-sm drop-shadow ml-4 text-violet-500'>
                                    {splitText('Andrei')}
                                </span>
                                <span className='tracking-widest font-custom font-bold drop-shadow ml-1 text-sm text-violet-500'>
                                    {splitText('R.')}
                                </span>
                                <span className='tracking-widest font-custom font-bold drop-shadow ml-1 text-sm text-violet-500'>
                                    {splitText('Parquez')}
                        ...
                        <div className="flex justify-center">
                            <a href="https://www.facebook.com/andrei.parquez.5" target="_blank" rel="noopener noreferrer">
                                <FaFacebookSquare className='size-6 text-blue-700 mx-2' />
                            </a>
                            <a href="https://github.com/AndreiParquez" target="_blank" rel="noopener noreferrer">
                                <TbBrandGithubFilled className='size-6 text-zinc-700 mx-2' />
                            </a>
